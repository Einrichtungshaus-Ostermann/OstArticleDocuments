 ...
 *
 * Reads every available .pdf document from multiple directories and shows them
...
namespace OstArticleDocuments;

use Shopware\Components\Plugin;
use Shopware\Components\Plugin\Context;
use Symfony\Component\DependencyInjection\ContainerBuilder;

class OstArticleDocuments extends Plugin
{
    /**
     * ...
     *
    ...
    public function build(ContainerBuilder $container)
    {
        ...
        $container->setParameter('ost_article_documents.plugin_dir', $this->getPath() . '/');
        $container->setParameter('ost_article_documents.view_dir', $this->getPath() . '/Resources/views/');
